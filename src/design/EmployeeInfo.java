...
public class EmployeeInfo  extends AbstractClass implements Employee {
    ...
    static String companyName="Farmer's Insurance ";
    ...
    public EmployeeInfo(String name, String address, int numberOfhours, String benefit, int empId) {
        this.name="Kamal";
        this.address="123 Skipper,Virginia";
    ...
    @Override
    public void meeting() {
        System.out.println("attending in all meetings");
    }
    ...
    public  void vacation(){
        System.out.println("I have a 21 days payed vacation");
    }
